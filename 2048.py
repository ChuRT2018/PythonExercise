	...
	def draw(self,screen):
		...
		def draw_hor_separator():
			...
			if not hasattr(draw_hor_separator,"counter"):
				draw_hor_separator.count = 0
			cast(separator[draw_hor_separator.counter])
			draw_hor_seqarator.counter += 1
...
def main(stdscr):
	...
	def not_game(state):
		...
		responses['Restart'],responses['Exit'] = 'Init','Exit' #对应转换到其他状态
